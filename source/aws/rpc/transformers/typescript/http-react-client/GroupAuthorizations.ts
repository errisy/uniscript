...
// import { GetUniRpcApiAuthUri, GetUniRpcApiClientId } from '../UniRpc.Environments';
...
//                 let clientId = GetUniRpcApiClientId();
//                 let authUri = GetUniRpcApiAuthUri();
//                 let loginUrl = `${authUri}/oauth2/authorize?client_id=${clientId}&response_type=token&redirect_uri=${window.location.protocol}//${window.location.host}&state=${encodeURIComponent(window.location.pathname)}`;
